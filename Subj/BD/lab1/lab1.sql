...
create table Characters(id int primary key, name varchar(20));
...
create table Corridor(
    ...
    Location_id_2 int not null references Location(id), check (Location_id_1 != Location_id_2)
    );


insert into Location(id, name) values(1, 'Променад');
insert into Location(id, name) values(2, 'Столовая');
insert into Location(id, name) values(3, 'Шлюз');

insert into Action(id, name) values(1, 'Пылесосить');
insert into Action(id, name) values(2, 'Кушать');
insert into Action(id, name) values(3, 'Курить');
insert into Action(id, name) values(4, 'Охранять');

insert into Characters(id, name) values (1, 'Чандра');
insert into Characters(id, name) values (2, 'Cандра');
insert into Characters(id, name) values (3, 'ЭАЛ');
...
insert into Person(id, sex, age) values(2, 'Female', 25);

insert into Robot(id, purpose) values(3, 'Робот-помощник');
insert into Robot(id, purpose) values(4, 'Робот-охранник');

insert into Signalization(Location_id, is_active) values(1, FALSE);
insert into Signalization(Location_id, is_active) values(2, FALSE);
insert into Signalization(Location_id, is_active) values(3, TRUE);
