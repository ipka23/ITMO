...
one_digit:
    ...
    ld res
    out 0x14                    ; иначе выводим цифру на позицию 0 и завершаем программу //TODO можно в теории потом просто добавить jump START чтобы калькулятор работал без остановки, но тогда нужно будет еще обнулять знак
    hlt
