...
<head>
    <meta charset="UTF-8">
    <title data-intl_type="custom" data-intl_value="pageTitle">
        Веб лаба 2
    </title>
    <link rel="stylesheet" href="css/index.css">

</head>
<script type="module" src="${pageContext.request.contextPath}/js/script.js" defer></script>
<body>
<header class="header">
    <label id="selectLang" class="selectLang">
        <select id="localeSelector">
            <option id="ru-RU" value="ru-RU">Русский</option>
            <option id="en-US" value="en-US">English</option>
            <option id="eo-EO" value="eo-EO">Esperanto</option>
        </select>
    </label>
    <span data-intl_type="custom" data-intl_value="student">
    ...
    <tr>
        ...
        <td>
            <form id="form" class="coordinates">
                <span data-intl_type="custom" data-intl_value="enterX">Введите X[-3; 3]:</span>
                <label><input id="inputX" min="-3" max="3" type="number" step="any" maxlength="5"></label>
                <br>
                <span id="xError" style="animation-duration: 2s"></span>
                <br>
                <span data-intl_type="custom" data-intl_value="enterY">Выберите Y:</span>
                ...
                <span id="yError"></span>
                <br>
                <span data-intl_type="custom" data-intl_value="enterR">Введите R[1; 4]:</span>
                <label><input id="inputR" min="1" max="4" type="number" step="any" maxlength="5"></label>
                <br>
                <span id="rError"></span>
                <br>
                <button data-intl_type="custom" data-intl_value="send" id="submitButton" type="submit">Отправить</button>
            </form>
        </td>
